...
public class CategoryAPITest {
    ...
    @Test
    void givenAValidCommand_whenCallCreateCategory_shouldReturnCategoryId() throws Exception {
    ...
    @Test
    void givenInValidName_whenCallCreateCategory_thenShouldReturnNotification() throws Exception {
    ...
    @Test
    void givenInValidCommand_whenCallCreateCategory_thenShouldReturnDomainException() throws Exception {
        final String expectedName = null;
        final var expectedDescription = "A categoria mais assistida";
        final var expectedIsActive = true;
        final var expectedMessage = "'name' should not be null";
